"""Evaluator-output formatting for StructuredModel comparison results.
...
def format_for_evaluator(
    ...
    for field_name, score in field_scores.items():
        if field_name in list_fields:
            ...
            items_metrics = calculate_list_item_metrics(
                field_name,
    ...
    # but the hierarchical structure has cm["fields"]["name"]["overall"]["tp"]
    flattened_confusion_matrix = _flatten_confusion_matrix_for_evaluator(
        confusion_matrix
    )
