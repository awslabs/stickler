...
def main():
    ...
    print(
        f"Page Level Accuracy:          {results['page_level_accuracy']['accuracy']:.2%}"
    )
    print(
        f"Split Accuracy (no order):    {results['split_accuracy_without_order']['accuracy']:.2%}"
    )
    print(
        f"Split Accuracy (with order):  {results['split_accuracy_with_order']['accuracy']:.2%}"
    )
    ...
    print(
        f"Page Level Accuracy:          {results2['page_level_accuracy']['accuracy']:.2%}"
    )
    print(
        f"Split Accuracy (no order):    {results2['split_accuracy_without_order']['accuracy']:.2%}"
    )
    print(
        f"Split Accuracy (with order):  {results2['split_accuracy_with_order']['accuracy']:.2%}"
    )
